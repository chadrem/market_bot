# Market Bot - Ruby scraper for Google Play (Android Market) [![Build Status](https://travis-ci.org/chadrem/market_bot.svg?branch=master)](https://travis-ci.org/chadrem/market_bot)
