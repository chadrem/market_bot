...
Gem::Specification.new do |gem|
  ...
  gem.authors       = ['Chad Remesch', 'Prutheus']
  gem.email         = ['chad@remesch.com', 'mail@prutheus.com']
  ...
  gem.homepage      = 'https://github.com/prutheus/market_bot'
  ...
  gem.add_dependency('mechanize', '>= 2.7.5')
